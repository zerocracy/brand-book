...
\slide{
  ...
  \vspace{1em}
  {\intro\begin{multicols}{2}
  In Zerocracy, money follows results---not hours, effort, or promises.
  Work has value only when it produces something measurable and accepted.
  We don't pay for participation, meetings, or intentions.
  A merged pull request, a verified bug report, a completed ticket---that's what earns a reward.
  \par\columnbreak\par
  This rule removes subjectivity and politics from software development.
  It protects both sides: programmers are paid fairly for what they deliver, and architects spend only on proven outcomes.
  When everyone is accountable to the same metric---delivered value---the system stays honest, efficient, and self-correcting.
  \end{multicols}\par}}
