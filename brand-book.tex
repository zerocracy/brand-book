...
\usepackage{textcomp}
\usepackage{iexec}
  \iexec[quiet,log]{wget -nc --quiet https://www.zerocracy.com/svg/logo.svg}
\usepackage{href-ul}
\usepackage{svg}
\usepackage{multicol}
\usepackage{setspace}
...
\usepackage{xcolor}
  \iexec[quiet,log]{wget --quiet --no-clobber https://www.zerocracy.com/css/palette.css}
...
\newcommand\header[1]{{\scshape\LARGE\textcolor{red}{#1:}\\[1em]\par}}
\newcommand\intro{\rmfamily\normalsize\leftskip=0pt\rightskip=0pt\parfillskip=0pt plus 1fil\setlength{\parindent}{1.5em}}
\newcommand\hatch[1]{
  \tikz{
    \node[fill=#1, minimum width=2em, minimum height=3em] (p) {};
    \node[font={\small}, anchor=north] (hex) at (p.south) {\parbox{4em}{\centering #1 \\ hex}};}}
...
\slide{%
  ...
  Zerocracy
  \\[2em]
  {\large\textcolor{red}{\textbf{Brand Book}}\par}}
