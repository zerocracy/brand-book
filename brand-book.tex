...
\usepackage{xcolor}
  \definecolor{zwhite}{HTML}{fdfffc}
...
\newcommand\header[1]{{\scshape\LARGE\textcolor{zred}{#1:}\\[1em]\par}}

\slide{%
  \includesvg[width=4em]{logo.svg}\\
  Zerocracy
  \\[2em]
  {\large\textcolor{zred}{\textbf{Brand Book}}\par}}
...
\slide{
  ...
  \newcommand\hatch[2]{
    ...
    \tikz{
      ...
      \node[font={\small}, anchor=north] (hex) at (p.south) {\parbox{4em}{\centering #1 \\ #2}};}}
  \hatch{0c090d}{black}
  \hatch{ba1200}{red}
  \hatch{526760}{gray}
  \hspace{1em}
...
\slide{
  ...
  \end{multicols}\par}
  {\small\url{https://fonts.google.com/noto/specimen/Noto+Sans}\par}}
